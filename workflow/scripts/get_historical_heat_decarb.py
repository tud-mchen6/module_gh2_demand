...
def process_countries_heat_decarb(inputs : str, countries, output_dir : str, output_file : str, year: int = 2023):
    """
    ...
    list_nonCarb_carriers = ['EHBIOMASS', 'EHWASTE', 'EHNUCLEAR', 'EHSOLARTH', 'EHGEOTHERM']
    ...
    # Do some cleaning
    df_all = pd.Series(dict_country_heat_decarb).to_frame(name='HEAT_DECARB').reset_index().rename(columns={'index':'ISO3'})
